  ...
  return (
    <main className="flex-1 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-16">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 sm:p-8 shadow-[0_2px_12px_rgba(18,22,28,0.08)] border border-neutral-200/80">
        <h1 className="font-heading text-xl sm:text-2xl font-bold text-primary-900">Welcome back</h1>
        <p className="mt-1 text-xs sm:text-sm text-neutral-600">Log in to continue your learning or teaching.</p>
        ...
        <button
          ...
          className="mt-5 sm:mt-6 flex h-11 w-full items-center justify-center gap-3 rounded-xl border border-neutral-200 bg-white text-xs sm:text-sm font-semibold text-neutral-700 transition hover:bg-neutral-50 disabled:opacity-60 cursor-pointer shadow-2xs"
        >
        ...
        <form action={action} className="flex flex-col gap-4">
          ...
          <div>
            <div className="flex items-center justify-between">
              <label htmlFor="password" className="block text-xs sm:text-sm font-medium text-neutral-900">
                Password
              </label>
              <Link
            ...
            <div className="relative mt-1">
              <input
                ...
                className={`h-11 w-full rounded-xl border px-3.5 pr-10 text-sm sm:text-base outline-none transition focus:ring-1 ${
            ...
            {state?.errors?.password && (
              <p className="mt-1 text-xs sm:text-sm text-error-600">{state.errors.password[0]}</p>
            )}
          </div>
